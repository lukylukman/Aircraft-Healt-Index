...
export function Confirmable(options?: SweetAlertOptions) {
  ...
  return (target: Object, propertyKey: string, descriptor: PropertyDescriptor) => {
    ...
    const config: SweetAlertOptions = {
      title: options != undefined && options?.title ? options?.title : options != undefined && options?.title ? options?.title : 'Are you sure?',
      html: options != undefined && options?.html ? options?.html : 'Do you want to perform this action?',
      showDenyButton: options != undefined && options?.showDenyButton ? options?.showDenyButton : true,
      confirmButtonText: options != undefined && options?.confirmButtonText ? options?.confirmButtonText : 'Yes',
      denyButtonText: options != undefined && options?.denyButtonText ? options?.denyButtonText : 'No',
      icon: options != undefined && options?.icon ? options?.icon : undefined,
